/**
 * StateAggregator — Type Definitions
...
// Tissue Identity
export const TISSUE_ID = 'TIS-STATEAGG-v0.1.0' as const;
export const TISSUE_HASH = '747f69b9' as const;
export const CLASSIFICATION = 'Cross-Functional' as const;
export const COMPOSED_CELLS = ['CEL-STATESTORE', 'CEL-STATESYNC', 'CEL-STATEMERGE'] as const;
